...
const Home: React.FC<HomeProps> = ({ setView, imageJobs, videoJobs, musicJobs, chatSessions, aiSearchResults }) => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      className="flex flex-col lg:flex-row gap-8 lg:gap-12 home-view"
    >
      ...
      {/* Right Column: Explore Modules */}
      <motion.div variants={itemVariants} className="lg:w-1/3 flex flex-col">
